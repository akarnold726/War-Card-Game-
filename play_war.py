...
def play_war(): 
    ...
    while round_number < 10000 and win_state is False:
        ...
        print("Oppenent played" + o_deck[0]["name"])
        p_deck = p_deck[1:]
        o_deck = o_deck[1:]
        if cards_in_play[0]["value"] == cards_in_play[1]["value"]:
            ...
            while war_state is True:
                ...
                if len(p_deck) < 3 or len(o_deck) < 3:
                    ...
                    if len(o_deck) < 3: 
                        end_message = "You win the game, oppenent ran out of cards"
                    war_state = False
                    win_state = True 
                else: 
                ...
                if len(p_deck) == 0:
                    ...
                    win_state = True 
                if len(o_deck) == 0:
                    end_message = "you win the game :) Congrats!!"
                    win_state = True 
                this_rounds_cards = []
